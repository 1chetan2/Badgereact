...
const TemplateEditorPage = () => {
  ...
  return (
    ...
    >
      ...
      <Navbar
        bg="white"
        className="border-bottom px-4 py-2 sticky-top shadow-sm"
      >
        <Button
          variant="link"
    ...
    {/* Templates status buttons */}
        <Nav className="ms-auto d-flex align-items-center gap-3">
          <div>
            <Button
              variant={templateStatus === "Published" ? "success" : "light"}
              className={` px-3 py-1 fw-bold border-0 ${templateStatus === "Published" ? "shadow-sm" : "text-secondary"}`}
            ...
            <Button
              ...
              className={` px-3 py-1 fw-bold border-0 ${templateStatus === "Draft" ? "shadow-sm" : "text-secondary"}`}
      ...
      <div className="d-flex flex-grow-1 overflow-hidden h-100">
        ...
        <div
          className="border-end bg-white overflow-auto h-100"
        ...
        <div className="flex-grow-1 bg-light h-100 position-relative p-4 overflow-auto d-flex justify-content-center">
          <div style={{ width: "fit-content" }}>
            ...
            <div className="text-center text-muted small opacity-75">
              <i className="bi bi-info-circle me-1"></i> Drag and resize
        ...
        <div
          className="border-start bg-white overflow-auto h-100"
