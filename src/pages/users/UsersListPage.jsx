...
const UsersListPage = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            // Ensure data is mapped to have a key for Ant Design Table
            const dataWithKeys = (response.data || []).map(user => ({
                ...user,
                key: user.id || user._id // assuming id field exists from backend
            }));
        ...
        confirm({
            ...
            onOk: async () => {
                try {
                    ...
                    // Remove from list without refetching if desired
